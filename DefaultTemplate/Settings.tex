...
\usepackage[acronym,xindy,toc]{glossaries} %TODO: include "acronym" if glossary and acronym should be separated Margins:   
%\makeglossaries
\usepackage{csquotes}
\usepackage{graphicx} %for including figures and images
\usepackage[acronym]{glossaries-extra} %for acronyms
%\usepackage{hyperref} %for inserting external links and coloring internal ones
    %\hypersetup{%need to be set up properly
     %   colorlinks=true, %different colored links at all
      %  linkcolor=blue, %internal references
       % urlcolor=red, %external links
        %pdftitle=(How to write a thesis)}%name of PDF download
